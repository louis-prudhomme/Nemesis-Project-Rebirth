...
class Seth extends Target implements IFoe {
  ...
  final static float SETH_SHOT_INTERVAL = Parameters.FRAMERATE * 0.5;
  ...
  Projectile shoot() {
    this.lastShot = 0;
    return new Shot(this.xpos, this.ypos, IPlayer.class, loadImage(SETH_SHOTS_SPRITE), SETH_SHOTS_SWIFTNESS, int(random(1, 4)));
  }
